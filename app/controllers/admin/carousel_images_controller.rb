class Admin::CarouselImagesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @carousel_image.save
        format.html { redirect_to admin_carousel_images_path, notice: 'Carousel image was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @carousel_image.update(carousel_image_params)
        format.html { redirect_to admin_carousel_images_path, notice: 'Carousel image was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_carousel_images_path, notice: 'Carousel image was successfully destroyed.' }
  ...
  private
    ...
    def carousel_image_params
      params.require(:carousel_image).permit(:name, :image)
    end
end
